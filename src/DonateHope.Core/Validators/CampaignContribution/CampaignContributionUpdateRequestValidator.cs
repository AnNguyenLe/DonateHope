...
public class CampaignContributionUpdateRequestValidator : AbstractValidator<CampaignContributionUpdateRequestDto>
{
    public CampaignContributionUpdateRequestValidator()
    {
